...
@section('title', 'Adauga inregistrare - Nuva.ro — Evidență financiară pentru profesioniști independenți')
        ...
        <form method="POST" action="{{ route('registru.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <div style="background:rgba(59,130,246,0.08);border:1px solid rgba(59,130,246,0.25);
                    ...
                    Nu ai datele firmei configurate.
                    <a href="{{ route('account.index') }}" style="color:var(--accent);">Completează-le din Contul meu</a>.
                </div>
            </div>
            @endif
